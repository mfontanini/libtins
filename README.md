...
## Building libtins - Using vcpkg ##

You can download and install libtins using the [vcpkg](https://github.com/Microsoft/vcpkg) dependency manager:
...
The libtins port in vcpkg is kept up to date by Microsoft team members and community contributors. If the version is out of date, please [create an issue or pull request](https://github.com/Microsoft/vcpkg) on the vcpkg repository.
